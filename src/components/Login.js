      ...
      {value ? <Home mode={mode} toggleMode={toggleMode} /> :
        <div className="container dd mt-5 p-5">
          <div className="content text-start justify-content p-5">
            ...
            <p style={{ fontSize: '30px', fontWeight: 'bold', color: mode === 'dark' ? 'white' : 'black' }} className="mt-0">Code Helping Website</p>
            ...
            <div>
              <form onSubmit={handleSubmit}>
                <div className="text-start">
                  <Link onClick={handleSubmit}><FcGoogle style={{ fontSize: "50px" }} /></Link>
                </div>
              </form>
            </div>
          </div>
          <div className="content text-end justify-content p-5">
            <img src={login} alt="Mac" />
          </div>
        </div>
