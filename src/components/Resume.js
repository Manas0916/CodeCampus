...
const Resume = () => {
  ...
  return (
    <>
        ...
        <h2 ><b><strong> Resume Building Guide: For Coding Interviews</strong></b></h2>
        </div>
        <div className="container text-start">
            <p className='h5 text-muted'>
                <br/>
                Are you confused on why you are not even shortlisted for the interview  despite mentioning 3 different
                programming languages, multiple pages of <br /> description, and much more quality things?
            </p>
            <p className='h5 text-muted'>
                <br />
                But <span ><strong style={{color: "#cf2d2d"}}>Dont Worry</strong></span> , 
            ...
            <p className='h5 text-muted'> <br/>Below are some of the key points that everyone should keep in mind while writing a Resume:</p>
            <ol>
                <br />
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Customizing Resume : </b></span></strong>
                    <p className='h5 text-muted my-3'>The most common mistakes everyone makes while writing a resume is to not customizing it as per the job requirements. <br /> It definitely requires extra time, but it is worth it. If you are applying for the role of Java Developer, and your resume doesn't <br /> contain your proficiency in Java then you are most likely to get rejected straight away.</p>
                </li>
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Name of the resume file : </b></span></strong>
                    <p className='h5 text-muted my-3'>We have seen some really cool names of resume files like, <i> proCoder.pdf ,
                ...
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Single Page Resume : </b></span></strong>
                    <p className='h5 text-muted my-3'>Recruiters do not have a lot of time to read everything that is written in a resume of 2-3 pages, they review a resume for <br />
                ...
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Don't include Career Objective :</b></span></strong>
                    <p className='h5 text-muted my-3'>This is also a common mistake done by job aspirants. A career objective generally read as, “Objective: To utilize my knowledge,<br /> 
                ...
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Include Accomplishments :</b></span></strong>
                    <p className='h5 text-muted my-3'>Making your resume accomplishment-oriented instead of responsibilities oriented will help recruiters understand your excellence in <br /> 
                    possible areas. Accomplishments state the things you have achieved and how well you have managed your responsibilities.</p>
                </li>
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Count Matters :</b></span></strong>
                    <p className='h5 text-muted my-3'>Do not misinterpret the meaning of the word count here. Count doesn't refer to the number of experiences or projects or certificates <br /> 
                ...
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Avoid Grammatical Mistakes :</b></span></strong>
                    <p className='h5 text-muted my-3'>Try to avoid any grammatical error in your resume. Do read it a couple of times before submitting it. We recommend using some <br /> 
                    plugins like “Grammarly”.</p>
                </li>
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Mention the relevant keywords : </b></span></strong>
                    <p className='h5 text-muted my-3'>If you are applying on the job portal of any company or probably have asked someone to refer you. On most of these portals, <br /> 
                ...
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>More content, less space :</b></span></strong>
                    <p className='h5 text-muted my-3'>Use a good resume template, with columns. This will allow you to fit more content on your resume while making it easier to scan for key <br /> 
                    information like company names and titles.</p>
                </li>
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Projects :</b></span></strong>
                    <p className='h5 text-muted my-3'>Pick your best projects (projects you were an integral part of and remember every ins and outs of it) to list in your resume. <br /> 
                ...
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Additional Experience : </b></span></strong>
                    <p className='h5 text-muted my-3'>You may also add additional experiences but it will be of benefit to you only when your additional experiences match with the <br /> 
                ...
                <li >
                    <strong className='h4' style={{color: "#cf2d2d"}}><span><b>Do not Fake :</b></span></strong>
                    <p className='h5 text-muted my-3'>Do not ever fake on a resume. Listing something fake on your resume has a very high chance of getting you into trouble. <br /> 
