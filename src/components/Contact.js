                ...
                <div className='container mt-1 mb-5 pb-5' style={{ borderRadius: '20px', backgroundColor: props.mode==='dark'?'#818081':'#f1f1f1' }}>
                    <form className="mt-5" ref={form} onSubmit={sendEmail}>
                        <div className="mb-3 text-start mt-5">
                            ...
                            <input type="text" name="user_name" className="form-control" placeholder="Enter your name" style={{ borderRadius: '15px' }} />
                        </div>
                        <div className="mb-3 text-start">
                            ...
                            <input type="email" name="user_email" className="form-control" placeholder="Enter your email address" style={{ borderRadius: '15px' }} />
                        </div>
                        <div className="mb-3 text-start">
                            ...
                            <textarea name="message" className="form-control" placeholder="Enter your message" style={{ height: '300px', borderRadius: '15px' }} />
                        </div>
